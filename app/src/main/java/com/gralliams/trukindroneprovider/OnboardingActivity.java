...
public class OnboardingActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private com.gralliams.trukindroneprovider.SliderAdapter sliderAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sliderAdapter = new com.gralliams.trukindroneprovider.SliderAdapter(this);
        ...
        switch (v.getId()){
            case R.id.btn_next:
                if (buttonNext.getText().toString().equalsIgnoreCase("next")){
                    ...
                    startActivity(new Intent(com.gralliams.trukindroneprovider.OnboardingActivity.this, MainActivity.class));
                    finish();
                }
                break;
